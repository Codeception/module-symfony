...
class Symfony extends Framework implements DoctrineProvider, PartedModule
{
    ...
    public function grabService($service)
    {
        ...
        if (!$container->has($service)) {
            $this->fail("Service $service is not available in container. If the service isn't injected anywhere in your app, you need to set it to `public` in `services.php`/`.yaml`");
        }
