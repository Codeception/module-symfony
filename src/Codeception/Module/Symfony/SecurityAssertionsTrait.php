...
trait SecurityAssertionsTrait
{
    ...
    /**
     * Asserts that a security firewall is configured.
     *
     * This checks that the firewall definition (or its context service) exists,
     * not whether it matched the current request.
     *
     * ```php
     * <?php
     * $I->seeFirewallIsConfigured('main');
     * ```
     */
    public function seeFirewallIsConfigured(string $firewallName): void
    {
